...
function NewsLetter() {
  ...
  return (
    ...
    <GlassCard>
        ...
        <form  onSubmit={handleSubmit} class="w-full mx-auto flex justify-between items-center gap-4">  
