  ...
  return (
    <nav className="fixed w-full z-20 top-0 start-0">
      <div className='container px-4 mx-auto mt-0 pt-0'>
        <div className="themeHeader backdrop-blur-sm color-ani px-4 pb-4">
          ...
          <div className="grid grid-cols-6 md:flex flex-nowrap items-center justify-between p-2 color-ani themeGlassBg rounded-b-xl">
            <span className="flex items-center space-x-3 rtl:space-x-reverse col-span-4">
              <Logo color="gray-700" darkColor="white" size="xxl" />
            </span>
            <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse col-span-2 justify-end">
    ...
    >
        ...
        <svg className="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
            ...
            <div className={`items-center justify-between ${menuOpen ? 'block' : 'hidden'} w-full md:flex md:w-auto md:order-1 col-span-6`} id="navbar-sticky">
